...
while equipe != "Nada":   # Estatísticas da equipe
    pontos = 0
    ...
    print("**** Resumo", equipe, "****")
    print("Vitórias:", vitorias_da_equipe, "Empates:", empates_da_equipe, "Derrotas:",
          derrotas_da_equipe)
    print("Pontos:", pontos)
    print("Diferença de gols marcados e sofridos:", diferenca)
    print("Gols marcados:", gols_marcados_pela_equipe, "Gols sofridos:",
          gols_sofridos_pela_equipe)
...
print("***** Estatísticas *****")
print("A equipe com menos pontos foi", equipe_menor_pontuacao, "com", menor_pontuacao,
      "pontos")
print("A equipe com melhor diferença de gols foi", equipe_melhor_pontuacao, 
      "com uma diferença de",
      melhor_pontuacao, "gols")
print(percentual_vitorias, "% vitórias", percentual_empates, "% empates",
      percentual_derrotas,
      "% derrotas")
